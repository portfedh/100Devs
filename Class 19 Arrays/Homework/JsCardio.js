...
// https://courses.wesbos.com/account/access/645f1e82cc9a7c5cbfcaf1b9/view/194130264
...
const inventors = [
    ...
    // You pass a function that is true or false
    let oldInventors = inventors.filter(
        function(inventor){
    ...
    let oldestInventors = inventors.sort(
        function(a, b){
    ...
    // Run in console of DOM of wikipedia page
    // 'mw-category' was found by poking around to find the class name
