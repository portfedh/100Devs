...
module.exports = function (passport) {
  ...
  // This line configures the serialization of a user object to the session.
  // user.id is stored in the session, which is used for subsequent requests to identify the user.
  passport.serializeUser((user, done) => {
    done(null, user.id);
  });

  // Given a user's ID stored in the session, it looks up the user in the database and calls the done callback.
