...
# Length = k
# Base = b
# x = integers of length k in descending order
# y = integers of length k in ascending order
# z = x - y with leading zeroes to keep length the same
# n = z to get the minion ID and  set x  and y
